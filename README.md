...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pwntools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11968&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pwntools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pwntools` can be installed with:

```
conda install pwntools
```

It is possible to list all of the versions of `pwntools` available on your platform with:
